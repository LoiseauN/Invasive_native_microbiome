...
gdmTab.dis <- gdm::formatsitepair(bioData= tax_q0_beta_matrix,
...
# edit data for gdm function
gdmTab.dis <- gdm::formatsitepair(bioData= tax_q1_beta_matrix,
                                  bioFormat=3, #diss matrix
                                  XColumn="longitude",
                                  YColumn="latitude",
                                  predData= metadata_filtered,
...
gdmTab.dis <- gdm::formatsitepair(bioData= phylo_q0_beta_matrix,
                                  bioFormat=3, #diss matrix
                                  XColumn="longitude",
                                  YColumn="latitude",
                                  predData= metadata_filtered,
...
# edit for gdm function
gdmTab.dis <- gdm::formatsitepair(bioData= phylo_q1_beta_matrix,
                                  bioFormat=3, #diss matrix
                                  XColumn="longitude",
                                  YColumn="latitude",
                                  predData= metadata_filtered,
...
# delete lake and samples
metadata_filtered <- dplyr::select(metadata_filtered, -lake, -samples)

# -------------- TAXO Q0 -------------------
# Add the 'site' column to the distance matrix
tax_q0_beta_matrix <- cbind(site, tax_q0_beta_matrix_lep)
